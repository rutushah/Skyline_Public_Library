         ...
         <div class="col-12 justify-content-center">
            ...
            enctype="multipart/form-data" novalidate>
               ...
               <div class="row mb-3">
                ...
                <div class="col-12 ms-5 justify-content-center">
                    <div class="row">
                     <div class="col-4"></div>
                     <div class="col-4">      
                            <input type="submit" class="btn btn-primary px-3 py-2 rounded-4  bg-success justify-content-center" name="Save" value="Save">
                            <input type="reset" class="btn btn-primary px-4 py-2 rounded-4  bg-success" name="back" value="Back" onclick = "window.location.href = 'admin_view_all_book.php'">
                        </div>
                        <div class="col-4"></div>
                        </div>
                        </div>
