...
try {     
    ...
    <body> 
        ...
        <table cellspacing="0" width: 100%;"> 
            <tr> 
                <td>Hello, '.$email.' We regret to inform that Your ID Proof do not match. Admin Declined Your Request. Please Register Yourself Again to Skyline
                Library with valid proof.</td> 
            </tr>
        </table> 
    </body> 
    </html>'; 
