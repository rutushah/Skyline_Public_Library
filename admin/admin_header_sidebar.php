...
?>
    ...
    <nav class="navbar fixed-top flex-md-nowrap shadow success">
        <a class="logo_place navbar-website col-sm-3 col-md-2 mr-0 nav-link" href="#">
            ...
            Unwind Nainital-->
            <img style="height=300px; width: 200px;" src="./images/nainital_logo.png">
        </a> 
        <span class="welcome_msg">Welcome, <?php echo "Komal Vekariya"; ?></span>
        <ul class="navbar-nav">
