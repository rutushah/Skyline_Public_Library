...
<?php
    ...
    $bookNameError = $isbnNoError = $authorNameError = $priceError = $shortDescriptionError = $categoryError = $editionError = $publishYearError = $eBookError = $rackInformationError = $bookImageError = "";
               ...
               <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div>
                        ...
                        <input class="form-control fw-lighter" type="file" id="eBook" name="eBook" accept="application/pdf">
                            ...
                            <input type="submit" class="btn btn-primary px-3 py-2 rounded-4  bg-success justify-content-center" name="Save" value="Save">
                              ...
                              <!-- <a class="text-success" href='user_login.php?role=user'> -->
                                 <input type="reset" class="btn btn-primary px-4 py-2 rounded-4  bg-success" name="back" 
                                    onclick = "window.location.href = 'staff_view_all_book.php'"
                                 value="Back">
                              <!-- </a> -->
                              </div>
                        <div class="col-4"></div>
